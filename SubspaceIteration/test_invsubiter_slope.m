...
OutNames = './Figure/' + MatNames + '_ISI_slope.pdf';
...
dlmwrite('./Figure/Data_ISI_slope.txt', date, '-append', 'delimiter', '', 'precision', 4);
for fileNo = 1 : 11

    disp(MatNames(fileNo));
    dlmwrite('./Figure/Data_ISI_slope.txt', fileNo, '-append', 'delimiter', '', 'precision', 4);
    ...
    % save data
    dlmwrite('./Figure/Data_ISI_slope.txt', timeL(fileNo, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_ISI_slope.txt', iterL(fileNo, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_ISI_slope.txt', resL{fileNo}(1, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_ISI_slope.txt', resL{fileNo}(2, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_ISI_slope.txt', shrinklistL(fileNo, :), '-append', 'delimiter', ',', 'precision', 4);
