...
OutNames = './Figure/' + MatNames + '_TM_slope.pdf';
...
dlmwrite('./Figure/Data_TM_slope.txt', date, '-append', 'delimiter', '', 'precision', 4);

for fileNo = 1 : 8

    % load matrix
    disp(MatNames(fileNo));
    dlmwrite('./Figure/Data_TM_slope.txt', fileNo, '-append', 'delimiter', '', 'precision', 4);
    ...
    ftime = tic;
    [xx, bb, iter, res, SEconfig.shrinklist] = myTraceMin(A, B, X, nev, tol, Maxiter, Sconfig, SEconfig);
    ...
    % save data
    dlmwrite('./Figure/Data_TM_slope.txt', timeL(fileNo, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_TM_slope.txt', iterL(fileNo, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_TM_slope.txt', resL{fileNo}(1, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_TM_slope.txt', resL{fileNo}(2, :), '-append', 'delimiter', ',', 'precision', 4);
    dlmwrite('./Figure/Data_TM_slope.txt', shrinklistL(fileNo, :), '-append', 'delimiter', ',', 'precision', 4);
