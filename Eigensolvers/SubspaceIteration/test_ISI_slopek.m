...
FigureOut = fullfile(RootPath, "Figure", MatNames + "_ISI_slopek.pdf");
DataOut = fullfile(RootPath, "Figure", "Data_ISI_slopek.txt");
...
for fileNo = 1 : 3
    ...
    legend("ISI", "ISI with shrink", "shrink point", "expand point");
    xlabel("Iterations");
    ylabel("Res");
    set(gca,'FontSize',16);
