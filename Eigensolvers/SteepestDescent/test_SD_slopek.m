...
FigureOut = fullfile(RootPath, "Figure", MatNames + "_SD_slopek.pdf");
DataOut = fullfile(RootPath, "Figure", "Data_SD_slopek.txt");
...
for fileNo = 1 : 3
    ...
    legend("SD", "SD with shrink", "shrink point", "expand point");
    xlabel("Iterations");
    ylabel("Res");
    set(gca,'FontSize',16);
